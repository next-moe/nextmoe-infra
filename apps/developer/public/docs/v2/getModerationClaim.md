# Get one moderation claim · Public API v2
...
id is the catalog work id. Site-fenced. Requires a user access token bound to a catalog site. The token must carry the catalog:edit scope.
