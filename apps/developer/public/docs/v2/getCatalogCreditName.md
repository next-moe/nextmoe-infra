# Get one credit name · Public API v2
...
```bash
curl "https://api.nextmoe.dev/v2/catalog/credit-names/value" \
  -H "Authorization: Bearer nmk_live_<YOUR_KEY>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/getCatalogCreditName
