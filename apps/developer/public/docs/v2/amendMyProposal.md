# Append an amendment · Public API v2
...
## POST /v2/me/proposals/{id}/amendments
...
```bash
curl -X POST "https://api.nextmoe.dev/v2/me/proposals/value/amendments" \
...
---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/amendMyProposal
