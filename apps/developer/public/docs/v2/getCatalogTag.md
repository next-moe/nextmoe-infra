...
## GET /v2/catalog/tags/{id}

Get one tag

Canonical tag. include=intros adds the per-language tag descriptions. Requires an application key or a user access token with catalog:read.
...
```bash
curl "https://api.nextmoe.dev/v2/catalog/tags/value" \
  -H "Authorization: Bearer nmk_live_<YOUR_KEY>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/getCatalogTag
