# Delete a draft claim · Public API v2
...
```bash
curl -X DELETE "https://api.nextmoe.dev/v2/me/claims/value" \
  -H "Authorization: Bearer <ACCESS_TOKEN>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/deleteMyClaim
