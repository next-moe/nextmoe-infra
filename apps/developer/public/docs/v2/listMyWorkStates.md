# List my work states · Public API v2
...
## GET /v2/me/work-states

List my work states

The bearer user's per-work states. work_ids= is a batch read. Requires a user access token. Any app may call this; no scope is required.
...
```bash
curl "https://api.nextmoe.dev/v2/me/work-states" \
  -H "Authorization: Bearer <ACCESS_TOKEN>"
```

---
本页来源 · NextMoe 开发者平台 · https://developer.nextmoe.dev/docs/v2/listMyWorkStates
