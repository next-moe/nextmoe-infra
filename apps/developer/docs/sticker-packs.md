...
### 例一：某个角色的全部表情 {#example-character}
...
**网关写的（401、429）**——请求还没到表情包站就被拦下。`instance` 是你请求的那条路径：
...

{
  ...
  "instance": "/v2/sticker/packs?limit=20",
