...
type Trait struct {
	...
	Intros         *[]Intro                 `json:"intros,omitempty" doc:"Present when include=intros. Trait descriptions, one per language: en (the plain text of description) and zh-Hans when recorded. Empty array if none."`
