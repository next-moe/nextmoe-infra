...
func selfServiceBadRequest(err error) (string, bool) {
	...
	case goerrors.Is(err, ErrUserScopeNotAllowed):
		return "scope not permitted for a self-service app (want openid / profile / email / playtime:read / playtime:write / folder:read / folder:write / catalog:edit / catalog:read / preferences)", true
